...
>   | otherwise = Bind k' v' l (bstDelete k r)
...
> ofList :: [(Int, Char)] -> BST Int Char
> ofList = foldl (\t (k, v) -> bstInsert k v t) Emp

> genBal :: Gen (BST Int Char)
> genBal = elements $ take 2 $ repeat $ ofList [(3, 't'), (2, 'r'), (1, 'l')]
